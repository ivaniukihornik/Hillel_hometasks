...
def data_checking(data: str):
    ...
    if data.count('.') == 1:
        ...
        check_result = False
    time.sleep(1)  # штучно додав затримки у функції, бо інакше у більшості випадків вони виконуються занадто швидко і
                   # і в тривалості виводяться нулі
    return check_result
...
def season_determination(date: str):
    ...
    if month_int in (3, 4, 5):
        ...
        season = 'Winter'
    time.sleep(2)  # штучно додав затримки у функції, бо інакше у більшості випадків вони виконуються занадто швидко і
    # і в тривалості виводяться нулі
    return season
...
def stupid_calculator(num1_str: str, num2_str: str, oper: str):
    ...
    if num1_str.replace('.', '').isdigit() and num2_str.replace('.', '').isdigit() is False:
        ...
        if oper == '+':
            ...
            print('Operation not supported!')
            result = None
    time.sleep(3)  # штучно додав затримки у функції, бо інакше у більшості випадків вони виконуються занадто швидко і
    # і в тривалості виводяться нулі
    return result
